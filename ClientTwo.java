...
public class ClientTwo {
	...
	static ClientTwo client;
	static StringBuilder code = new StringBuilder();
	String id = "p2", image; //change
    ...
    String IPAddress, winner = null, p1FinalData = null; //change p2FinalData
    String[] resultPacket;
   ...
   /* private String getName() {
    ...
    private void run() throws IOException {
        ...
        while (true) {
            ...
            /*else if(line.startsWith("RESULTS")){
            	...
            	differenceImageLabel.setText("Difference: " + resultPacket[1] + "%");
            	opponentDiffImageText.setText("Difference: " + resultPacket[0] + "%");
               	if(p1Wins == true){
                ...
                ImageIO.write(bufferedImage1, "png", new File("p2OpponentFinalImage.png")); //change
                ...
                ImageIO.write(bufferedImage2, "png", new File("p2MyFinalImage.png")); //change
                
                label_2.setText("");
                label_2.setIcon(new ImageIcon("p2MyFinalImage.png")); //change
                ...
                ImageIO.write(bufferedImage3, "png", new File("p2MyDiffImage.png")); 
                ...
                ImageIO.write(bufferedImage4, "png", new File("p2OpponentDiffImage.png")); 
    ...
    private void buildGUI(){
        ...
        textArea.setText("public void draw(){rect(40,40,90,40);}");//delete
    ...
    private void differenceImage(){
    	...
    	code.insert(0, "import processing.core.PApplet; import processing.core.PImage;"
    			...
    			+ "PApplet.main(\"differenceImageTwo\");}public void settings(){imageOne = loadImage(masterImage, \"png\");" //change (differenceImageOne)
    					...
    					+ "save(\"differenceImageTwo.png\"); System.exit(1); }}"); //change (differenceImageOne)
